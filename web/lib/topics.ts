...
export const TOPICS: Topic[] = [
  {
    ...
    keywords: [
      ...
      'copilot', 'llm', 'mô hình ngôn ngữ', 'generative', 'claude', 'midjourney',
      'stable diffusion', 'anthropic', 'microsoft ai', 'google ai', 'meta ai',
    ],
  },
  {
    slug: 'vang',
...
/** Categorize an article by checking its title against topic keyword lists (priority order). */
